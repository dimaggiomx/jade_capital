    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <!-- /.dropdown -->
                <li class="dropdown"> <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Y_USERNAME</b> </a>
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <p><?php
                            ...
                            for($i=1; $i<17; $i++)
                            {
                                echo $_SESSION["ses_p_$i"]; echo '<br/>';
                            }
