...
if(!is_dir($storeFolder.$ds.$dir1.$ds.$dir2.$ds.$dir3)){
    //Directory does not exist, so lets create it.
    mkdir($storeFolder.$ds.$dir1.$ds.$dir2.$ds.$dir3, 0755);
}
...
if (!empty($_FILES)) {
    ...
    $bdFilePath = $storeFolder . $ds .$dir1.$ds.$dir2.$ds.$dir3.$ds.$_FILES['file']['name'];
