...
<div class="navbar-default sidebar" role="navigation" >
    <div class="sidebar-nav navbar-collapse slimscrollsidebar" >
        ...
        <ul class="nav" id="side-menu">
            ...
            <div class="user-profile">
                <div class="dropdown user-pro-body">
                    <?php if($_SESSION["ses_ctipo"] == 'I'){ ?><button class="btn btn-block btn-rounded btn-info" aria-expanded="false" type="submit" id="btn-sendsubasta"><i data-icon="/" class="fa fa-credit-card-alt"></i> <span class="hide-menu">INVERTIR</span></button>
                    <?php } ?>
                </div>
            </div>
