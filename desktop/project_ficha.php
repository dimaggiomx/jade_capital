...
<head>
    ...
    <title><?php echo C_P_TITLE; ?> - Ficha de Proyecto</title>
                ...
                <div class="modal-content">
                    ...
                    <form id="formSubasta" name="formSubasta" action="project_aprob.php" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="message-text3" class="control-label">Porcentaje:</label>
                                <input type="text" class="form-control" id="cporcentaje" name="cporcentaje"></input>
                            </div>
                            <input type="hidden" class="form-control" id="cidproyecto" name="cidproyecto"></input>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default waves-effect" data-dismiss="modal" id="btn-cerrar">Close</button>
                            <button type="submit" class="btn btn-danger waves-effect waves-light" id="btn-invertir">Enviar Inversión</button>
                        </div>
                    </form>
                </div>
            <!-- .right-sidebar -->
