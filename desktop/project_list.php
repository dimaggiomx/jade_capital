    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Mis Proyectos</h3>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="formSubasta" name="formSubasta" action="project_aprob.php" method="post">
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" id="cidproyecto" name="cidproyecto"></input>
                            </div>
...
<script src="tproyectos/ps_projects.js"></script>
<!-- para las tablas -->
