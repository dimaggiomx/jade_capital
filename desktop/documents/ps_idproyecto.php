...
if (!empty($_FILES)) {
    ...
    $targetFile = $targetPath.$dir1.$ds.$dir2.$ds.'ine_'.$_FILES['file']['name']; //5
    $bdFilePath = C_P_GALERIA . $ds .$dir1.$ds.$dir2.$ds.'ine_'.$_FILES['file']['name'];
    ...
    // registro foto
    $response = $myReg->upd_identificacionfiscales($DBcon,$dir2,$bdFilePath);
    $myReg->upd_tavance($DBcon,$dir2,"cs4", 1);
