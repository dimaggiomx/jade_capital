$(document).ready(function() {
    $(function() {
        ...
        // para el cuadrito que desaparece superior derecho
        /*
        $.toast({
        ...
        // para el msg abajo
        $('#r_resultDiv').slideDown('fast', function(){
            $('#r_resultDiv').html('<i class="ti-user"></i> Cargado en cuanto abre la pagina. <a href="#" class="closed">&times;</a> ');
